...
períodos, o período imperial e período neo\hyp{}hitita.
...
\paragraph{Neo\hyp{}hitita \slash{} Era do Ferro} \emph{Circa} 1100-700 \textsc{aec},
...
\begin{figure}[htb]
	...
	\caption[Cartas de Assur]{Cartas de Assur. Rolos de chumbo de aproximadamente 4cm de altura e
		...
		Escavados em Assur em 1905 pela \emph{Deutsche Orientgesellschaft}.
		Originalmente alocados no \emph{Eski Şark Eserleri Müzesi}, apenas os
		fragmentos \emph{e} e \emph{f} estão preservados e locados no
		\emph{Vorderasiatisches Museum}, Berlin, no. VA 5819.
...
período neo\hyp{}hitita, em verde, que se concentram sobretudo no sudeste da Anatólia
...
\begin{figure}[b]
	...
	\caption[Mapa das inscrições monumentais]{Mapa contendo a localização das
		...
		período neo\hyp{}hitita.}\label{fig:mapa1}
\end{figure}
...
pode ver no mapa em~\autoref{fig:mapa2} ao fim deste capítulo.
...
como se pode ver no mapa em~\autoref{fig:mapa3} ao fim deste capítulo.


\section{Parentesco linguístico}

O lúvio é uma língua indo-europeia pertencente ao ramo anatólico.
O proto\hyp{}indo-europeu (\textsc{pie}) é uma língua hipotética reconstruída a
...
línguas germânicas e as balto\hyp{}eslávicas, secundariamente, e as célticas,
...
seria o proto\hyp{}indo-europeu e qual sua relação com essa recém descoberta língua.
...
indo-europeu, comumente chamado de ramo \emph{anatólico}.\footnote{Não cabe aqui
	...
	língua que poderia ser chamada de indo-hitita \slash{} indo\hyp{}anatólico,
...
\begin{inparaenum}
	...
	indo-europeia *\emph{-mi} por \emph{-wi} em todas as línguas menos hitita;
